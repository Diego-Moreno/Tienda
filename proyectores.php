...
?>
	...
	<?php	
            ...
            $sql = "select id_producto,nombre_prod,marca,precio,descripcion, nombre_categ, imagen from productos inner join categorias on categoria_id = id_categoria where nombre_categ = 'Proyectores'";
